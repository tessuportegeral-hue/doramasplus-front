...
export default function RecommendedDoramas() {
  ...
  const fetchDoramas = async () => {
    ...
    try {
      ...
      console.error('Error fetching recommended doramas:', err);
      setError(true);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <>
      <Helmet>
        <title>Recomendados - DoramaStream</title>
      </Helmet>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
            <div>
              ...
              <p className="text-slate-400 mt-2">
                Nossa curadoria especial com os melhores doramas para você.
              </p>
            </div>
            ...
            <div className="relative w-full md:w-72">
              ...
              <input
                ...
                className="w-full bg-slate-900/50 border border-slate-800 rounded-full pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all"
              />
            </div>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-slate-900/50 rounded-xl border border-slate-800 max-w-lg mx-auto">
              ...
              <p className="text-red-400">Não foi possível carregar os doramas recomendados.</p>
              <button 
            ...
            <div className="text-center py-20 text-slate-500 bg-slate-900/30 rounded-2xl border border-slate-800/50 border-dashed">
              <p className="text-lg">Nenhum dorama recomendado encontrado.</p>
