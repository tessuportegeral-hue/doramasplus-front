    ...
    <>
      ...
      <button
        ...
        style={{
          position: "fixed",
          bottom:
            "calc(24px + var(--dp-install-banner-h, 0px) + var(--dp-bottom-nav-h, 0px))",
          right: "24px",
          width: "56px",
          height: "56px",
          borderRadius: "50%",
      ...
      {open && (
        <div
          style={{
            position: "fixed",
            bottom: isMobile
              ? "calc(80px + var(--dp-install-banner-h, 0px) + var(--dp-bottom-nav-h, 0px))"
              : "calc(90px + var(--dp-install-banner-h, 0px) + var(--dp-bottom-nav-h, 0px))",
