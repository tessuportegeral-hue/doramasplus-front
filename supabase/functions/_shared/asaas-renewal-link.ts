// ⚠️ 30/07: NÃO importado por nenhuma function no momento. Guardado de
// propósito — o lembrete de renovação voltou a usar InfinityPay (achado
// 30/07 que o link de checkout Pix da InfinityPay nunca tinha parado de
// funcionar de verdade, só o cartão de crédito). Se o InfinityPay quebrar
// de novo, é só importar createAsaasCheckoutLink aqui em resolveRenewalLink
// (whatsapp-renewal-cron / email-renewal-reminder) igual já foi feito antes.
//
