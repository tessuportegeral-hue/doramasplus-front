...
async function creditReferralIfEligible(
  ...
  try {
    ...
    // pagou antes por outro canal e migrou pro Stripe)
  ...
  try {
    ...
    async function handleInvoicePaid(
      ...
      try {
        ...
        try {
          const referralResult = await creditReferralIfEligible(userId);
        ...
        try {
          const pendingResult = await resolvePendingReferralsForReferrer(userId);
